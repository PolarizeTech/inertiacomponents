...
import { InertiaLink, Head } from '@pckg/@inertiajs/inertia-react';
import { mergeCssClasses as classNames } from '@blazervel-ui/utils';
import React, { PropsWithChildren, useState } from '@pckg/preact/compat';

import { useTypedPage } from '@ja-inertia//utils';
import ApplicationMark from '@ja-inertia/react/jetstream/components/ApplicationMark';
import Banner from '@ja-inertia/react/jetstream/components/Banner';
import Dropdown from '@ja-inertia/react/jetstream/components/Dropdown';
import DropdownLink from '@ja-inertia/react/jetstream/components/DropdownLink';
import NavLink from '@ja-inertia/react/jetstream/components/NavLink';
import ResponsiveNavLink from '@ja-inertia/react/jetstream/components/ResponsiveNavLink';
