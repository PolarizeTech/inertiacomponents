  ...
  return (
    <div>
      ...
      <select
        id={id}
        name={name}
        className={`${className} block w-full pl-3 pr-10 py-2 h-11 text-base border-chrome-300 dark:border-chrome-700 bg-white dark:bg-chrome-800 dark:text-white focus:outline-none focus:ring-theme-200 focus:border-theme-500 sm:text-sm rounded-md`}
