...
import { router as Inertia } from '@pckg/@inertiajs/react';
import { Link, Head } from '@pckg/@inertiajs/react';
import { mergeCssClasses as classNames } from '@ja-inertia/utils';
import { useTypedPage } from '@ja-inertia/utils';
import ApplicationMark from '@ja-inertia/vendor/jetstream/components/ApplicationMark';
import Banner from '@ja-inertia/vendor/jetstream/components/Banner';
import Dropdown from '@ja-inertia/vendor/jetstream/components/Dropdown';
import DropdownLink from '@ja-inertia/vendor/jetstream/components/DropdownLink';
import NavLink from '@ja-inertia/vendor/jetstream/components/NavLink';
import ResponsiveNavLink from '@ja-inertia/vendor/jetstream/components/ResponsiveNavLink';
import { Team } from '@ja-inertia/types';
